class CartsController < ApplicationController
  ...
  def show
    ...
    @cant_add_purchase_reason += 'Add a category first! ' if @categories.length == 0
    @cant_add_purchase_reason += 'Add a subcategory first! ' if @subcategories.length == 0
    @cant_add_purchase_reason += 'Add a product first! ' if @products.length == 0
